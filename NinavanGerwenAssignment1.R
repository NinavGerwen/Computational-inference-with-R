...
Profile_Plot <- ggplot(data = total_data, aes(x = Group.2, y = x, group = Condition, colour = Group.1)) +
  ...
  ## change the colours for the different conditions and apply a general theme
  scale_colour_manual(values = c("#2166AC", "#B2182B")) + theme_bw() +
